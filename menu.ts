...
function menusVisible(isVisible: boolean){
    areaOneVisible(isVisible)
    tryAgainVisible(isVisible)

    Good_job.setFlag(SpriteFlag.Invisible, !isVisible)
    Next_Level.setFlag(SpriteFlag.Invisible, !isVisible)
    MenuS.setFlag(SpriteFlag.Invisible, !isVisible)
    Restart.setFlag(SpriteFlag.Invisible, !isVisible)
}

function areaOneVisible(isVisible: boolean){
    Title.setFlag(SpriteFlag.Invisible, !isVisible);
    StartButton.setFlag(SpriteFlag.Invisible, !isVisible);
    Credits.setFlag(SpriteFlag.Invisible, !isVisible);
    Level_1.setFlag(SpriteFlag.Invisible, !isVisible);
    Level_2.setFlag(SpriteFlag.Invisible, !isVisible);
    Level_3.setFlag(SpriteFlag.Invisible, !isVisible);
}

function circuitVisible(isVisible: boolean){
    switchBlock.setFlag(SpriteFlag.Invisible, !isVisible);
    switchPlatform.setFlag(SpriteFlag.Invisible, !isVisible);
    blockOverlay.setFlag(SpriteFlag.Invisible, !isVisible);
    curBlock.setFlag(SpriteFlag.Invisible, !isVisible);
    goal.setFlag(SpriteFlag.Invisible, !isVisible);
    battery.setFlag(SpriteFlag.Invisible, !isVisible);
    bottomOverlayTest.setFlag(SpriteFlag.Invisible, !isVisible);
}

function tryAgainVisible(isVisible: boolean){
    Uh_oh.setFlag(SpriteFlag.Invisible, !isVisible)
    TryAgain.setFlag(SpriteFlag.Invisible, !isVisible)
    MenuTA.setFlag(SpriteFlag.Invisible, !isVisible)
}
...
Uh_oh.setFlag(SpriteFlag.Invisible, true)
TryAgain.setFlag(SpriteFlag.Invisible, true)
MenuTA.setFlag(SpriteFlag.Invisible, true)
